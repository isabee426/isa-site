...
// Which icon shows is decided in CSS from the theme, so the server and client render the same markup.
export default function ThemeToggle() {
  ...
  return (
    <button type="button" className="theme-toggle" onClick={toggle} aria-label="Toggle dark mode">
      ...
      <svg className="icon-sun" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" aria-hidden="true">
